...
Partial Class CustEyePatientDetails
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Not Regex.Match(TextBox1.Text, "^[a-z,., ,]*$", RegexOptions.IgnoreCase).Success Then
            MsgBox("Please enter valid patient name")
            Exit Sub
        End If
        ...
        Conn.Open()
        SqlStr = "insert into  EyePatientTab values("
        SqlStr = SqlStr & "'" & Application("CustVar") & "_" & TextBox1.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & DropDownList1.Text & "','" & String.Format("{0:dd/MMM/yyyy}", d1) & "','" & TextBox4.Text & "','" & TextBox5.Text & "','N','" & Application("CustVar") & "')"
